...
$.ajax({
  ...
  data: '{"data":{"x":'+$('#oax').val()+',"y":'+$('#oay').val()+',"zoomLevel":2,"ignorePositions":[]}}'}).done(
...
function setLayout() {
  ...
  $('#sidebarBoxOasisList').find('div.content').append($('<p>X<input id="oax" value="98" type="text" style="width: 40px;margin-left: 10px;margin-right: 10px;text-align:right;">Y <input id="oay" value="-89" type="text" style="width: 40px;margin-left: 10px;margin-right: 10px;text-align:right;"></p><p>Delay <input id="oad" value="100" type="text" style="width: 50px;margin-left: 10px;margin-right: 10px;text-align:right;"></p><button id="setOasesButt" type="button" class="textButtonV1 green">Start</button><span id="oaCounter" style="font-weight: bold;margin-left: 36px;"></span>'));
